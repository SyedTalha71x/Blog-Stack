        ...
        <>
            <div className="categorymainpage h-full w-[70%] m-auto cursor-pointer p-10">
                ...
                <div className="category_row grid grid-cols-6 mt-6 w-full">
                    ...
                    <div className="row_2 grid grid-cols-2 bg-yellow-400 p-4 rounded-lg m-1">
                        <div className="leftrow">
                    ...
                    <div className="row_3 grid grid-cols-2 bg-yellow-600 p-4 rounded-lg m-1">
                        <div className="leftrow">
                    ...
                    <div className="row_4 grid grid-cols-2 bg-gray-300 p-4 rounded-lg m-1">
                        <div className="leftrow">
                    ...
                    <div className="row_5 grid grid-cols-2 bg-slate-400 p-4 rounded-lg m-1">
                        <div className="leftrow">
                    ...
                    <div className="row_6 grid grid-cols-2 bg-sky-300 p-4 rounded-lg m-1">
                        <div className="leftrow">
